...
function Ourteam() {
  return (
    <div className="w-11/12 mx-auto lg:w-3/4 lg:mx-auto md:w-11/12 md:mx-auto py-10 pt-4 pb-16 md:pb-10 md:pt-16">
      <h1 className="flex justify-center text-textGreish text-3xl  items-center text-center md:text-4xl lg:text-2xl font-bold pb-4 md:pb-12 lg:pb-5">
        Our Team
      </h1>
      <p className="flex justify-center items-center text-base text-textGreish pb-16 md:pb-20">
