...
function OurServices({ ServicePage, Service, Subscribe }) {
  return (
    <>
      <Screendetails
      ...
      <div className="max-w-screen-2xl mx-auto ">
        ...
        <div className="w-3/5 md:w-11/12 lg:w-4/6 mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 lg:gap-12">
          <div className="shadow-xl py-8 px-12 rounded-[30px] bg-white">
            ...
            <p className="text-center mb-4 font-lato font-light text-black">
              Lorem Ipsum Dummy Text Here
            </p>
            <ul className="list-disc">
              <li className=" marker:text-blue-600 font-lato font-light text-PriceFillColor">
                Lorem Ipsum Dummy
              </li>
              <li className=" marker:text-blue-600 font-lato font-light text-PriceFillColor">
                Lorem Ipsum Dummy
          ...
          <div className="shadow-xl py-8 px-12 rounded-[30px] bg-BackgroundAUcolor">
            ...
            <p className="text-center mb-4 font-lato font-light text-white">
              Lorem Ipsum Dummy Text Here
            </p>
            <ul className="list-disc">
              <li className=" marker:text-blue-600 font-lato font-light text-white">
                Lorem Ipsum Dummy
              </li>
              <li className=" marker:text-blue-600 font-lato font-light text-white">
                Lorem Ipsum Dummy
