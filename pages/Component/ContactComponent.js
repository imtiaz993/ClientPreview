...
const ContactComponent = ({
  ...
  return (
    ...
    >
      <h1 className="text-3xl  text-Flandingtext1 font-bold">{contactTitle}</h1>
      <p className="lg:w-1/3 text-black mx-auto my-8 md:w-1/2 w-11/12 text-sm">
        {contactDesc}
      </p>
      <div className="flex justify-center">
        ...
        <div className="">
          <button className=" text-textGreish border-2  border-linearGrad w-36 h-12 text-base py-2 px-4 rounded-[30px] lg:mr-4">
            {button2Text}
          </button>
        </div>
      </div>
