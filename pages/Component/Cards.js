...
function Cards(props) {
  return (
    <div
      className={` py-8 px-4 max-w-sm mx-auto bg-white text-textGreish rounded-lg shadow-lg flex flex-col justify-center items-center hover:bg-darkBlue hover:text-white`}
    >
