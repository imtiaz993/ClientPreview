    ...
    <div className="w-11/12 mx-auto lg:w-3/4 lg:mx-auto md:w-11/12 md:mx-auto">
        ...
        <div className={`lg:flex ${props.className} md:flex md:${props.className}`}>
          <div className="flex flex-col justify-center  md:flex md:flex-row  lg:w-2/3 md:w-1/2  " >
            <div className=" mt-20">
            <p className="w-auto text-black text-5xl md:text-left pb-5 lg:pb-0 md:pb-0 text-center  lg:text-5xl lg:text-left md:text-4xl">
              {props.title}
            </p>
            
            <p className=" w-auto text-blue-600 font-bold text-5xl pb-10 text-center lg:text-5xl lg:text-left md:text-left md:pb-5 md:text-4xl">
                {props.title2}
            </p>
          ...
          <div className="lg:flex lg:flex-col justify-center md:flex md:flex-row lg:w-2/3 md:w-1/2 pt-10 pb-14   ">
