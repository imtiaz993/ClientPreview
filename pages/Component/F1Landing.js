        ...
        <div className="md:mr-2 lg:mr-8 flex flex-col justify-center   lg:w-2/3 md:w-1/2  md:pt-20 ">
          <div className="">
            ...
            <p className="  text-textGreish w-3/4 mx-auto md:w-full text-3xl md:text-lg lg:text-left pb-2 mt-4 md:mt-0">
              {props.landTitle}
              <span className="bg-linearGrad  rounded-full w-9 flex p-1  mt-20 mb-4"></span>
            </p>

            <p className="text-Flandingtext1 font-lato font-black w-3/4 mx-auto md:w-full  text-xl text-left lg:text-3xl lg:text-left lg:pb-8 lg:p lg:t-4 md:text-2xl md:text-left pb-8 md:top-4">
              {props.landCapTitle}
            </p>
            <p className=" w-auto text-Flandingtext font-lato font-medium text-sm text-left lg:text-sm lg:text-left lg:pb-5 md:text-left md:text-sm md:pb-5">
              {props.title3}
            </p>
            <p className=" w-auto text-Flandingtext font-lato font-medium text-sm  text-left pb-5 lg:text-sm lg:text-left lg:pb-5 md:text-left md:text-sm md:pb-5">
              {props.title2}
            </p>
